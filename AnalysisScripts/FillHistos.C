...
void FillHistos::Loop()
{
  ...
  TH1F *hrelIsoWithDBeta_barrel = new TH1F("relIsoWithDBeta_barrel", "", 150, 0, 3); 
  TH1F *hrelIsoWithDBeta_endcap = new TH1F("relIsoWithDBeta_endcap", "", 150, 0, 3); 
